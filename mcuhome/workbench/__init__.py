...
:mod:`mcuhome.workbench.configuration` the five-layer option model
:mod:`mcuhome.workbench.builders`      named builders and their selection
...
every other module here may change shape between releases.
"""

...
def test_a_matter_device_without_credentials_is_refused(write_config) -> None:
    ...
    assert "mcuhome device create-matter-pairing bench-node" in (error.hint or "")
...
def test_half_written_credentials_name_what_is_missing(write_config) -> None:
    ...
    assert "mcuhome device create-matter-pairing bench-node --force" in (error.hint or "")
...
def test_an_empty_matter_block_is_still_the_opt_in(write_config) -> None:
    ...
    assert "create-matter-pairing" in (error.hint or "")
